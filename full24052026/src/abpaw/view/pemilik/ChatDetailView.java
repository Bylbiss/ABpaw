...
public class ChatDetailView extends JFrame {
    ...
    private final Color colorBiru = new Color(0, 102, 204);
    ...
    private void initComponents() {
        ...
        topPanel.setBackground(colorBiru);
        ...
        sendButton.setBackground(colorBiru);
    ...
    private void loadChatHistory() {
        ...
        chatPanel.removeAll();
        for (Chat c : chats) {
            // Cek apakah pesan ini dikirim oleh pemilik yang sedang login
            boolean isFromMe = "pemilik".equals(c.getPengirim());
    ...
    private void addMessageBubble(String message, Timestamp waktu, boolean isFromMe) {
        ...
        Color bgColor = isFromMe ? colorBiru : new Color(240, 240, 240);
        int radius = 15;
    ...
    private void sendMessage(ActionEvent e) {
        ...
        if (!isPemesananAktif(dokter.getIdDokter())) {
            JOptionPane.showMessageDialog(this,
                    "Tidak dapat mengirim pesan. Konsultasi dengan dokter ini sudah selesai.\nChat hanya tersedia untuk pemesanan yang masih berlangsung.",
                    "Chat Tidak Tersedia",
    ...
    private boolean isPemesananAktif(int idDokter) {
        // Cek pemesanan online milik pemilik ini
        ...
        // Cek pemesanan offline milik pemilik ini
