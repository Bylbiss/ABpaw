...
public class ManageKuponView extends JPanel {
    ...
    private static final Color biru = new Color(0, 102, 204);
    private static final Color biruTerang = new Color(200, 220, 255);
    ...
    private void initComponents() {
        ...
        styleButton(btnTambah, new Color(34, 139, 34));
    ...
    private class KuponFormDialog extends JDialog {
        ...
        private void initComponents() {
            ...
            gbc.gridx = 1;
            panel.add(txtDiskonPersen, gbc);

            gbc.gridy = 3;
            gbc.gridx = 0;
            panel.add(new JLabel("Maksimum Diskon (Rp):"), gbc);
            txtDiskonMaks = new JTextField(15);
            gbc.gridx = 1;
            panel.add(txtDiskonMaks, gbc);

            gbc.gridy = 4;
            gbc.gridx = 0;
            panel.add(new JLabel("Minimal Pembelian (Rp):"), gbc);
            txtMinPembelian = new JTextField(15);
            gbc.gridx = 1;
            panel.add(txtMinPembelian, gbc);

            gbc.gridy = 5;
            gbc.gridx = 0;
            panel.add(new JLabel("Berlaku Hingga (YYYY-MM-DD):"), gbc);
            txtBerlakuHingga = new JTextField(15);
            gbc.gridx = 1;
            panel.add(txtBerlakuHingga, gbc);

            gbc.gridy = 6;
            gbc.gridx = 0;
            panel.add(new JLabel("Aktif:"), gbc);
            chkAktif = new JCheckBox();
            gbc.gridx = 1;
            panel.add(chkAktif, gbc);
        ...
        private void loadDataToForm() {
            ...
            if (kupon.getBerlakuHingga() != null) {
                txtBerlakuHingga.setText(kupon.getBerlakuHingga().toString());
            }
