...
public class DashboardDokterView extends JFrame {
    ...
    private final Color GREEN_MAIN = new Color(0, 128, 0);
    ...
    private void initComponents() {
        ...
        headerPanel.setBackground(GREEN_MAIN);
        headerPanel.setBorder(BorderFactory.createEmptyBorder(10, 20, 10, 20));

        ImageIcon pawIcon = IconHelper.getScaledPawIcon(35, 35);
        JLabel logoLabel = new JLabel(" AB Paw - Dokter Panel", pawIcon, SwingConstants.LEFT);
        ...
        sidebar.setBackground(GREEN_LIGHT);
            ...
            public void run() {
                ...
                SwingUtilities.invokeLater(() -> {
                    for (Component comp : contentPanel.getComponents()) {
                        if (comp.isVisible() && comp instanceof UpdateStatusView) {
                            ((UpdateStatusView) comp).loadPemesanan();
                        }
                    }
                });
            }
    ...
    private void editProfilDokter() {
        ...
        int row = 0;
        gbc.gridy = row++;
        formPanel.add(new JLabel("Nama Depan:"), gbc);
        gbc.gridx = 1;
        formPanel.add(txtNamaDepan, gbc);
        gbc.gridx = 0;
        gbc.gridy = row++;
        formPanel.add(new JLabel("Nama Belakang:"), gbc);
        gbc.gridx = 1;
        ...
        gbc.gridx = 0;
        gbc.gridy = row++;
        formPanel.add(new JLabel("Biaya Konsultasi (Rp):"), gbc);
        gbc.gridx = 1;
        formPanel.add(txtBiaya, gbc);
        gbc.gridx = 0;
        gbc.gridy = row++;
        formPanel.add(new JLabel("Spesies Hewan (pisah koma):"), gbc);
        gbc.gridx = 1;
        formPanel.add(txtSpesiesHewan, gbc);
        gbc.gridx = 0;
        gbc.gridy = row++;
        formPanel.add(new JLabel("Password Baru (kosongkan jika tidak diubah):"), gbc);
        gbc.gridx = 1;
        formPanel.add(txtPassword, gbc);

        JButton btnSimpan = new JButton("Simpan Perubahan");
        btnSimpan.setBackground(GREEN_MAIN);
        ...
        btnSimpan.addActionListener(e -> {
            ...
            try {
                ...
                if (biaya.compareTo(BigDecimal.ZERO) <= 0) {
    ...
    private JPanel createProfilPanel() {
        ...
        editBtn.setBackground(GREEN_MAIN);
