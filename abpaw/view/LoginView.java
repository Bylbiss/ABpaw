...
public class LoginView extends JFrame {
    ...
    private void initComponents() {
        ...
        JLabel titleLabel = new JLabel("Silahkan Masuk ke Akun Anda");
        ...
        buttonWrapper.add(btnLogin);
        
        gbc.gridy = 3;
        gbc.gridx = 0;
        gbc.gridwidth = 2;
        formPanel.add(buttonWrapper, gbc);
    ...
    private void login() {
        ...
        try { //panggil poly
            ...
            if (user == null) {
                ...
                System.err.println("Login gagal untuk username: " + username);
                return;
            }
