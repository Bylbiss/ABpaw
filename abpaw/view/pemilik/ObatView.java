...
public class ObatView extends JPanel {
    ...
    private void initComponents() {
        ...
        JButton btnRefreshResep = new JButton("Refresh");
        btnRefreshResep.setBackground(new Color(232, 62,140));
        btnRefreshResep.setForeground(Color.WHITE);
        btnRefreshResep.setFocusPainted(false);
        btnRefreshResep.setMargin(new Insets(2, 10, 2, 10));
        btnRefreshResep.addActionListener(e -> loadResep());
        headerPanel.add(btnRefreshResep, BorderLayout.EAST);

        resepPanel.add(headerPanel, BorderLayout.NORTH);
        ...
        btnDetail.setBackground(new Color(232, 62, 140));
    ...
    private JPanel createObatCard(Obat obat) {
        ...
        beliBtn.setBackground(new Color(232, 62, 140));
    ...
    private void showPaymentDialog(Obat obat, int jumlah, BigDecimal total) {
        ...
        bayarBtn.setBackground(new Color(232, 62, 140));
    ...
    private void detailResep() {
        ...
        int idResep = (int) resepModel.getValueAt(row, 4);
    ...
    private void styleTabbedPane(JTabbedPane tabbedPane) {
        Color biru = new Color(232, 62, 140);
        ...
        tabbedPane.setUI(new javax.swing.plaf.basic.BasicTabbedPaneUI() {
            ...
            protected void paintText(Graphics g, int tabPlacement, Font font, FontMetrics metrics, int tabIndex, String title, Rectangle textRect, boolean isSelected) {
                ...
                g2.setFont(font);
                int mnemIndex = tabbedPane.getDisplayedMnemonicIndexAt(tabIndex);
