...
public class ProfilPemilikView extends JPanel {
    ...
    private void initComponents() {
        ...
        tabbedPane.setBackground(new Color(232, 62, 140));
    ...
    private JPanel createProfilPanel() {
        ...
        formCard.setBorder(BorderFactory.createLineBorder(new Color(232, 62, 140), 1));
        ...
        txtNamaLengkap.setBorder(BorderFactory.createCompoundBorder(
                BorderFactory.createLineBorder(new Color(232, 62, 140)),
        ...
        btnSimpanProfil.setBackground(new Color(232, 62, 140));
        btnSimpanProfil.setForeground(Color.WHITE);
    ...
    private JPanel createHewanPanel() {
        ...
        tableHewan.getTableHeader().setBackground(new Color(232, 62, 140));
        tableHewan.getTableHeader().setForeground(Color.WHITE);
        tableHewan.setSelectionBackground(new Color(232, 62, 140));
        tableHewan.setSelectionForeground(Color.WHITE);

        tableHewan.setDefaultRenderer(Object.class, new javax.swing.table.DefaultTableCellRenderer() {
            @Override
            public java.awt.Component getTableCellRendererComponent(JTable table, Object value,
                ...
                if (!isSelected) {
                    ...
                    c.setBackground(new Color(232, 62, 140));
        ...
        btnTambahHewan.setForeground(Color.WHITE);
        ...
        btnEditHewan.setForeground(Color.WHITE);
        ...
        btnHapusHewan.setForeground(Color.WHITE);
    ...
    private class HewanDialog extends JDialog {
        ...
        private void initComponents() {
            ...
            btnSave.setBackground(new Color(232, 62, 140));
        ...
        private void loadDataToForm() {
            ...
            if (pet.getTanggalLahir() != null) {
                txtTanggalLahir.setText(pet.getTanggalLahir().toString());
            }
            if (pet.getUsia() != null) {
                txtUsia.setText(String.valueOf(pet.getUsia()));
            }
            if (pet.getBerat() != null) {
                txtBerat.setText(pet.getBerat().toString());
            }
