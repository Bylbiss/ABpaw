...
public class Kupon {
    ...
    // ini ya method bisnis
    // hitung potongan berdasarkan total belanja
    ...
    // Method untuk mengecek masa berlaku kupon
    ...
    public BigDecimal getDiskonPersen() {
        return diskonPersen;
    }
    ...
    public BigDecimal getDiskonMaks() {
        return diskonMaks;
    }

    public void setDiskonMaks(BigDecimal diskonMaks) {
        this.diskonMaks = diskonMaks;
    }

    public BigDecimal getMinimalPembelian() {
        return minimalPembelian;
    }

    public void setMinimalPembelian(BigDecimal minimalPembelian) {
        this.minimalPembelian = minimalPembelian;
    }
