...
public class ManagePemilikView extends JPanel {
    ...
    private static final Color biruTerang = new Color(204, 229, 255); 
    private static final Color biruGelap = new Color(0, 82, 163);
    ...
    private void initComponents() {
        ...
        btnEdit.addActionListener(e -> {
            ...
            if (row != -1) {
                ...
                JOptionPane.showMessageDialog(this, "Pilih pemilik yang akan diedit.");
            }
        });
    ...
    private void loadData() {
        ...
        List<Pemilik> list;
        if (keyword.isEmpty()) {
            list = pemilikController.getAllPemilik();
        } else {
            list = pemilikController.searchPemilik(keyword);
        }
        for (Pemilik p : list) {
    ...
    private class PemilikFormDialog extends JDialog {
        ...
        private void initComponents() {
            ...
            gbc.gridy = 2;
            gbc.gridx = 0;
            panel.add(new JLabel("Password Baru (kosongkan jika tidak diubah):"), gbc);
