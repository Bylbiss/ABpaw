...
// Kelas untuk manajemen data dokter (CRUD)
public class ManageDokterView extends JPanel {
    ...
    private final Color biruTerang = new Color(220, 235, 255);
    ...
    private void initComponents() {
        ...
        // Tabel dengan model DefaultTableModel (tidak bisa diedit langsung)
        ...
        styleButton(btnTambah, biru);
        styleButton(btnEdit, biru);
        styleButton(btnHapus, new Color(220, 20, 60));
        styleButton(btnRefresh, new Color(255, 140, 0));
    ...
    // Membuka dialog form untuk tambah/edit (inner class)
    ...
    // Inner class – Form dialog menggunakan konsep encapsulation dan event handling
    private class DokterFormDialog extends JDialog {
        ...
        private void initComponents() {
            ...
            gbc.gridy = 0;
            panel.add(new JLabel("Nama Depan:"), gbc);
            txtNamaDepan = new JTextField(15);
            gbc.gridx = 1;
            panel.add(txtNamaDepan, gbc);
            gbc.gridy = 1;
            gbc.gridx = 0;
            panel.add(new JLabel("Nama Belakang:"), gbc);
            txtNamaBelakang = new JTextField(15);
            gbc.gridx = 1;
            panel.add(txtNamaBelakang, gbc);
            gbc.gridy = 2;
            gbc.gridx = 0;
            ...
            gbc.gridx = 1;
            panel.add(txtSpesialisasi, gbc);
            gbc.gridy = 8;
            gbc.gridx = 0;
            panel.add(new JLabel("Biaya Konsultasi:"), gbc);
            txtBiaya = new JTextField(15);
            gbc.gridx = 1;
            panel.add(txtBiaya, gbc);
            gbc.gridy = 9;
            gbc.gridx = 0;
            panel.add(new JLabel("Spesies Hewan (pisah koma):"), gbc);
            txtSpesiesHewan = new JTextField(15);
            gbc.gridx = 1;
            panel.add(txtSpesiesHewan, gbc);

            btnSave = new JButton("Simpan");
            styleButton(btnSave, biru);
